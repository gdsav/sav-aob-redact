...
export function AzureShowSamlMetadataWireFrame() {
  ...
  const toNextStep = () => {
    navigate("/azure/registered-app/step5", { state: token });
  };
                  ...
                  <tr>
                    <td>
                      <span className="caption">
                        Load SAML Metadata for the Identity Provider
                      </span>
                    </td>
                    <td>
